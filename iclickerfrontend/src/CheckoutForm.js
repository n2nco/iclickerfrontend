...
const CheckoutForm = () => {
  ...
  return (
    <>
      ...
      <Box maxWidth={300} position="relative" marginRight="min(20vw)" marginLeft="min(20vw)" paddingTop="0px" margin='auto' alignItems="flex-start" justifyContent="center" marginTop="-100px">
