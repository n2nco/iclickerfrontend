...
const InputForm = () => {
  ...
  return (
    <div style={{paddingTop: '90px', marginBottom: "-230px", paddingBottom: "10px"}} onChange={onDivWrapperChange}>
      ...
      {/* <Grid container> */}
       ...
       {/* Reffer box + input */}
        <FormControlLabel style={{marginTop:"-10px", marginBottom: "-43px", width: '40px'}} control={<Checkbox checked={checked} onChange={handleChange}   style={{marginTop:"-30px",
            transform: "scale(0.6)",
        }}/>} 
        label={
